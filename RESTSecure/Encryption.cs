...
namespace RESTSecure
{
    class Encryption
    {
        ...
        public void EncryptFile(string path, string password, string outputFile)
        {
        ...
        public void DecryptFile(string path, string password, string outputPath)
        {
            ...
            File.WriteAllBytes(outputPath, bytesDecrypted);
        }
